...
float setting_maxShiftWeightT= 0.04f * (640 + 192);   // original is 0.04f * (640+480);
float setting_maxShiftWeightR= 0.0f * (640 + 192);    // original is 0.0f * (640+480);
float setting_maxShiftWeightRT= 0.02f * (640 + 192);  // original is 0.02f * (640+480);

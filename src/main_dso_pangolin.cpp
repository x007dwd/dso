...
int main( int argc, char** argv )
{
    ...
    std::thread runthread([&]() {
        std::vector<int> idsToPlay;				//左图id列表
        std::vector<double> timesToPlayAt;		//
        
        std::vector<int> idsToPlayRight;		//右图id列表
        ...
        fullSystem->printResult("/home/jiatianwu/dso/sdso_latest/result.txt");

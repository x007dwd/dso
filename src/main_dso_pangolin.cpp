...
int main(int argc, char **argv) {
  // setlocale(LC_ALL, "");
  // 	std::string  argvString1=
  // "files=/media/bobin/DATA1/SLAM/data/TUM-Monocular/Mono/all_sequences/sequence_01/images.zip";
  // 	std::string  argvString2 =
  // "calib=/media/bobin/DATA1/SLAM/data/TUM-Monocular/Mono/all_sequences/sequence_01/camera.txt";
  // 	std::string  argvString3 =
  // "gamma=/media/bobin/DATA1/SLAM/data/TUM-Monocular/Mono/all_sequences/sequence_01/pcalib.txt";
  // 	std::string  argvString4
  // ="vignette=/media/bobin/DATA1/SLAM/data/TUM-Monocular/Mono/all_sequences/sequence_01/vignette.png";
  // 	std::string  argvString5 ="preset=0";
  // 	std::string  argvString6 ="mode=0";
  std::string argvString1 =
      "files=/media/bobin/DATA1/SLAM/data/dataset/sequences/00/image_3";
  std::string argvString2 =
      "calib=/media/bobin/DATA1/SLAM/data/dataset/sequences/01/camera.txt";
  // 	std::string  argvString3 =
  // "gamma=/media/bobin/DATA1/SLAM/data/TUM-Monocular/Mono/all_sequences/sequence_01/pcalib.txt";
  // 	std::string  argvString4
  // ="vignette=/media/bobin/DATA1/SLAM/data/TUM-Monocular/Mono/all_sequences/sequence_01/vignette.png";

...
private:
	...
	void traceNewCoarseNonKeyWithMatchPic(FrameHessian* fh, FrameHessian* fh_right);


	// mainPipelineFunctions
	Vec4 trackNewCoarse(FrameHessian* fh,FrameHessian* fh_right);
	void traceNewCoarse(FrameHessian* fh,FrameHessian* fh_right);
	void activatePoints();
    ...
    // 计算双目深度
    void computeIdepth(FrameHessian* fh, FrameHessian* fh_right);

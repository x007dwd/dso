...
public:
	...
	ImmaturePointStatus traceleft(FrameHessian* frame, Mat33f K);
	ImmaturePointStatus traceright(FrameHessian* frame, Mat33f K);
	...
	ImmaturePointStatus lastTraceStatus_Stereo;
	Vec2f lastTraceUV;
	Vec2f lastTraceUV_Stereo;
	float lastTracePixelInterval;
	float lastTracePixelInterval_Stereo;

...
#define SCALE_B_INVERSE (1.0f / SCALE_B)
    ...
    /* precalc value 帧间的固定参数，主要是是帧间的位姿\xi,a,b
     * 这些值在函数setPrecalcValues中设置。
     *
    */
    struct FrameFramePrecalc {
        ...
        // precalc values
        Mat33f PRE_RTll;  // precalc value for rotation of left to left
        Mat33f PRE_KRKiTll; // precalc value for KRKi of left to left
        Mat33f PRE_RKiTll;  // precalc value for RKi of left to left
        Mat33f PRE_RTll_0; // precalc value for rotation of left to left_o

        Vec2f PRE_aff_mode;
        float PRE_b0_mode;

        Vec3f PRE_tTll;   // precalc value for translation of left to left
        Vec3f PRE_KtTll;  // precalc value for Kt of left to left
        Vec3f PRE_tTll_0; // precalc value for translation of left to left_0
